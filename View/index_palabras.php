...
<html>
    ...
    <script>
        ...
        function modificarSignificado(idSignificado) {
            Swal.fire({
                type: 'info',
                title: 'Modificando significado ',
                html: '<form name="formModificarSignificado" method="post" action="../Controller/ModificarSignificado.php">\n\
                <input type="hidden" name="idSig" value="' + idSignificado + '"> <input type="text" name="descripcion" placeholder="Descripción: :" > \n\
        ...
        function modificarPalabra(idPalabra) {
            Swal.fire({
                type: 'info',
                title: 'Modificando palabra ',
                html: '<form name="formModificarPalabra" method="post" action="../Controller/ModificarPalabra.php">\n\
                <input type="hidden" name="idPalabra" value="' + idPalabra + '"> <input type="text" name="nombre" placeholder="Palabra:" > \n\
              <input type="text" name="sigla" placeholder="Sigla:"> <input type="submit" value="Modificar">   </form>',
                showCancelButton: true,
                showConfirmButton: false,
                cancelButtonText: 'Cancelar',
                cancelButtonColor: '#d33'
